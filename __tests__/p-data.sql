...
insert into p.filterable
  (id, "bit4",  "bool", "bpchar4", "bytea", "char4", "cidr", "date",       "float4", "float8", "hstore",  "inet",         "int2", "int4", "int8", "interval",       "json", "jsonb",      "macaddr", "macaddr8", "money", "name", "numeric", "text", "time",     "timestamp",        "timestamptz",      "timetz",   "uuid",                                 "varbit", "varchar", "xml", "parent_id", "forward_id", "forward_compound_1", "forward_compound_2", "backward_compound_1", "backward_compound_2") values
  (1,  B'0001', false,  'test',    '\x01',  'test',  null,   '1999-01-01', 0.1,      0.1,      'key1=>1', '192.168.1/24', 1,      1,      1,      'P0Y0M1DT0H0M0S', null,   '{"key1":1}', null,      null,       0.1,     'test', 0.1,       'test', '00:01:00', '1999-01-01 00:00', '1999-01-01 00:00', '00:01:00', '00000000-0000-0000-0000-000000000001', B'0001',  'test',    null,  1,           1,            1,                    1,                    1,                     1),
  (2,  B'0010', true,   'tEST',    '\x02',  'tEST',  null,   '1999-02-01', 0.2,      0.2,      'key2=>2', '192.168.1.2',  2,      2,      2,      'P0Y0M2DT0H0M0S', null,   '{"key2":2}', null,      null,       0.2,     'tEST', 0.2,       'tEST', '00:02:00', '1999-02-01 00:00', '1999-02-01 00:00', '00:02:00', '00000000-0000-0000-0000-000000000002', B'0010',  'tEST',    null,  1,           2,            1,                    2,                    1,                     2),
  (3,  B'0011', false,  'Test',    '\x03',  'Test',  null,   '1999-03-01', 0.3,      0.3,      'key3=>3', '192.168.1.3',  3,      3,      3,      'P0Y0M3DT0H0M0S', null,   '{"key3":3}', null,      null,       0.3,     'Test', 0.3,       'Test', '00:03:00', '1999-03-01 00:00', '1999-03-01 00:00', '00:03:00', '00000000-0000-0000-0000-000000000003', B'0011',  'Test',    null,  2,           3,            2,                    1,                    2,                     1),
  (4,  B'0100', false,  'TEST',    '\x04',  'TEST',  null,   '1999-04-01', 0.4,      0.4,      'key4=>4', '192.168.1.4',  4,      4,      4,      'P0Y0M4DT0H0M0S', null,   '{"key4":4}', null,      null,       0.4,     'TEST', 0.4,       'TEST', '00:04:00', '1999-04-01 00:00', '1999-04-01 00:00', '00:04:00', '00000000-0000-0000-0000-000000000004', B'0100',  'TEST',    null,  2,           4,            2,                    2,                    2,                     2),
