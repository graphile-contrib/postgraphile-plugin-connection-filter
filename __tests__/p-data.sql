...
insert into p.array_types
  (id, "bit4_array",  "bool_array",    "bpchar4_array", "char4_array", "citext_array", "date_array",              "float4_array", "float8_array", "hstore_array",      "inet_array",                 "int2_array", "int4_array", "int8_array", "interval_array",                  "jsonb_array",                       "money_array", "numeric_array", "text_array",  "time_array",          "timestamp_array",                     "timestamptz_array",                   "timetz_array",        "uuid_array", "varbit_array", "varchar_array") values
  (1,  '{0001,0010}', '{false,true}',  '{TEST,Test}',   '{TEST,Test}', '{TEST,Test}',  '{1999-01-01,1999-02-01}', '{0.1,0.2}',    '{0.1,0.2}',    '{key1=>1,key2=>2}', '{192.168.1/24,192.168.1.2}', '{1,2}',      '{1,2}',      '{1,2}',      '{P0Y0M1DT0H0M0S,P0Y0M2DT0H0M0S}', '{"{\"key1\": 1}","{\"key2\": 2}"}', '{0.1,0.2}',   '{0.1,0.2}',     '{TEST,Test}', '{00:01:00,00:02:00}', '{1999-01-01 00:00,1999-02-01 00:00}', '{1999-01-01 00:00,1999-02-01 00:00}', '{00:01:00,00:02:00}', '{00000000-0000-0000-0000-000000000001,00000000-0000-0000-0000-000000000002}', '{0001,0010}',  '{TEST,Test}'),
  (2,  '{0010,0011}', '{true,false}',  '{Test,tEST}',   '{Test,tEST}', '{Test,tEST}',  '{1999-02-01,1999-03-01}', '{0.2,0.3}',    '{0.2,0.3}',    '{key2=>2,key3=>3}', '{192.168.1.2,192.168.1.3}',  '{2,3}',      '{2,3}',      '{2,3}',      '{P0Y0M2DT0H0M0S,P0Y0M3DT0H0M0S}', '{"{\"key2\": 2}","{\"key3\": 3}"}', '{0.2,0.3}',   '{0.2,0.3}',     '{Test,tEST}', '{00:02:00,00:03:00}', '{1999-02-01 00:00,1999-03-01 00:00}', '{1999-02-01 00:00,1999-03-01 00:00}', '{00:02:00,00:03:00}', '{00000000-0000-0000-0000-000000000002,00000000-0000-0000-0000-000000000003}', '{0010,0011}',  '{Test,tEST}'),
  (3,  '{0011,0100}', '{false,false}', '{tEST,test}',   '{tEST,test}', '{tEST,test}',  '{1999-03-01,1999-04-01}', '{0.3,0.4}',    '{0.3,0.4}',    '{key3=>3,key4=>4}', '{192.168.1.3,192.168.1.4}',  '{3,4}',      '{3,4}',      '{3,4}',      '{P0Y0M3DT0H0M0S,P0Y0M4DT0H0M0S}', '{"{\"key3\": 3}","{\"key4\": 4}"}', '{0.3,0.4}',   '{0.3,0.4}',     '{tEST,test}', '{00:03:00,00:04:00}', '{1999-03-01 00:00,1999-04-01 00:00}', '{1999-03-01 00:00,1999-04-01 00:00}', '{00:03:00,00:04:00}', '{00000000-0000-0000-0000-000000000003,00000000-0000-0000-0000-000000000004}', '{0011,0100}',  '{tEST,test}'),
  (4,  '{0100,0101}', '{false,false}', '{test,zest}',   '{test,zest}', '{test,zest}',  '{1999-04-01,1999-05-01}', '{0.4,0.5}',    '{0.4,0.5}',    '{key4=>4,key5=>5}', '{192.168.1.4,192.168.1.5}',  '{4,5}',      '{4,5}',      '{4,5}',      '{P0Y0M4DT0H0M0S,P0Y0M5DT0H0M0S}', '{"{\"key4\": 4}","{\"key5\": 5}"}', '{0.4,0.5}',   '{0.4,0.5}',     '{test,zest}', '{00:04:00,00:05:00}', '{1999-04-01 00:00,1999-05-01 00:00}', '{1999-04-01 00:00,1999-05-01 00:00}', '{00:04:00,00:05:00}', '{00000000-0000-0000-0000-000000000004,00000000-0000-0000-0000-000000000005}', '{0100,0101}',  '{test,zest}'),
...
insert into p.range_array_types
  ...
  (1,  array['[1999-01-01, 1999-02-01)', '[1999-02-01, 1999-03-01)']::daterange[], array['[1,2)','[2,3)']::int4range[], array['[1,2)','[2,3)']::int8range[], array['[1,2)','[2,3)']::numrange[], array['[1999-01-01 00:00, 1999-02-01 00:00)', '[1999-02-01 00:00, 1999-03-01 00:00)']::tsrange[], array['[1999-01-01 00:00, 1999-02-01 00:00)', '[1999-02-01 00:00, 1999-03-01 00:00)']::tstzrange[]),
  (2,  array['[1999-02-01, 1999-03-01)', '[1999-03-01, 1999-04-01)']::daterange[], array['[2,3)','[3,4)']::int4range[], array['[2,3)','[3,4)']::int8range[], array['[2,3)','[3,4)']::numrange[], array['[1999-02-01 00:00, 1999-03-01 00:00)', '[1999-03-01 00:00, 1999-04-01 00:00)']::tsrange[], array['[1999-02-01 00:00, 1999-03-01 00:00)', '[1999-03-01 00:00, 1999-04-01 00:00)']::tstzrange[]),
  (3,  array['[1999-03-01, 1999-04-01)', '[1999-04-01, 1999-05-01)']::daterange[], array['[3,4)','[4,5)']::int4range[], array['[3,4)','[4,5)']::int8range[], array['[3,4)','[4,5)']::numrange[], array['[1999-03-01 00:00, 1999-04-01 00:00)', '[1999-04-01 00:00, 1999-05-01 00:00)']::tsrange[], array['[1999-03-01 00:00, 1999-04-01 00:00)', '[1999-04-01 00:00, 1999-05-01 00:00)']::tstzrange[]),
  (4,  array['[1999-04-01, 1999-05-01)', '[1999-05-01, 1999-06-01)']::daterange[], array['[4,5)','[5,6)']::int4range[], array['[4,5)','[5,6)']::int8range[], array['[4,5)','[5,6)']::numrange[], array['[1999-04-01 00:00, 1999-05-01 00:00)', '[1999-05-01 00:00, 1999-06-01 00:00)']::tsrange[], array['[1999-04-01 00:00, 1999-05-01 00:00)', '[1999-05-01 00:00, 1999-06-01 00:00)']::tstzrange[]),
  (5,  null,                                                                       null,                                null,                                null,                               null,                                                                                             null);
