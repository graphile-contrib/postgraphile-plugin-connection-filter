...
insert into p.filterable (id, "text", "char4", "int2", "int4", "int8", "float4", "float8", "numeric", "bool", "jsonb", "text_array", "int4_array", "int4_range", "int8_range", "numeric_range", "timestamp_range", "timestamptz_range", "date_range", "inet", "enum", "parent_id", "forward_id", "forward_compound_1", "forward_compound_2", "backward_compound_1", "backward_compound_2") values
  (1, 'TEST', 'TEST', 1, 1, 1, 0.1, 0.1, 0.1, false, '{"key1":1}', '{1,2}', '{1,10}', '[1,2)', '[1,2)', '[1,2)', '[1999-01-01 00:00, 1999-02-01 00:00)', '[1999-01-01 00:00, 1999-02-01 00:00)', '[1999-01-01, 1999-02-01)', '192.168.0.1', 'sad', 1, 1, 1, 1, 1, 1),
